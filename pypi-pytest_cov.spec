...
Source0  : https://files.pythonhosted.org/packages/25/69/5f1e57f6c5a39f81411b550027bf72842c4567ff5fd572bed1edc9e4b5d9/pytest_cov-6.1.1.tar.gz
...
%prep
%setup -q -n pytest_cov-6.1.1
cd %{_builddir}/pytest_cov-6.1.1
pushd ..
cp -a pytest_cov-6.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744041429
...
cp %{_builddir}/pytest_cov-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-pytest_cov/07800edab5f4e77a7371e226f11ba91f963a11cf || :
