...
Source0  : https://files.pythonhosted.org/packages/18/99/668cade231f434aaa59bbfbf49469068d2ddd945000621d3d165d2e7dd7b/pytest_cov-6.2.1.tar.gz
...
%prep
%setup -q -n pytest_cov-6.2.1
cd %{_builddir}/pytest_cov-6.2.1
pushd ..
cp -a pytest_cov-6.2.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749736359
