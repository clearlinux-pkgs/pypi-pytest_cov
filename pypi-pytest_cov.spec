...
Source0  : https://files.pythonhosted.org/packages/34/8c/039a7793f23f5cb666c834da9e944123f498ccc0753bed5fbfb2e2c11f87/pytest_cov-6.1.0.tar.gz
...
%prep
%setup -q -n pytest_cov-6.1.0
cd %{_builddir}/pytest_cov-6.1.0
pushd ..
cp -a pytest_cov-6.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743516909
