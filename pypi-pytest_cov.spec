...
Source0  : https://files.pythonhosted.org/packages/74/67/00efc8d11b630c56f15f4ad9c7f9223f1e5ec275aaae3fa9118c6a223ad2/pytest-cov-5.0.0.tar.gz
...
%prep
%setup -q -n pytest-cov-5.0.0
cd %{_builddir}/pytest-cov-5.0.0
pushd ..
cp -a pytest-cov-5.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711373932
