...
Source0  : https://files.pythonhosted.org/packages/ea/70/da97fd5f6270c7d2ce07559a19e5bf36a76f0af21500256f005a69d9beba/pytest-cov-4.0.0.tar.gz
...
%prep
%setup -q -n pytest-cov-4.0.0
cd %{_builddir}/pytest-cov-4.0.0
pushd ..
cp -a pytest-cov-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664461893
